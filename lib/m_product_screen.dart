...
class MProductScreen extends StatefulWidget {
  ...
  @override
  _MProductScreenState createState() => _MProductScreenState();
}
...
class _MProductScreenState extends State<MProductScreen>
  ...
  @override
  void didUpdateWidget(MProductScreen oldWidget) {
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            height:
                                isMobile ? height * 0.0600 : height * 0.0680,
                            child: Row(
                              children: [
                                SizedBox(
                                    width:
                                        isMobile ? width * 0.12 : width * 0.18),
                                Transform.translate(
                                  offset: Offset(
                                      0,
                                      isMobile
                                ...
                                Container(
                                  width:
                                      isMobile ? width * 0.095 : width * 0.0807,
                                ...
                                Container(
                                  width:
                                      isMobile ? width * 0.15 : width * 0.1458,
                                  height: height * 0.0462,
                                  child: SelectableText(
...
• 마그네틱 교반기 Hei-PLATE Mix 'n' Heat Core+는 원하는 온도까지 설정할 수 있는디지털 디스플레이를 제공합니다.
  오버슈팅이 없는 이 정밀한 온도는 두 가지 선택 가능한 가열 모드(FAST/PRECISE)와 옵션인 외부 온도 센서 Pt1000에 의해 제어됩니다."""
                  },
                  {
                    "brand": "HEIDOLPH",
...
종합적인 공정 여건은 민감한 샘플의 안전한 운반에 전제조건입니다.
이는 오차 범위 ±0.5%의 제어 정확성과 정밀한 속도 조절(5~120rpm)로 보장됩니다.
게다가 옵션인 풋 스위치로 폐쇄된 배기 후드에서 펌프가 작동할 수 있습니다.
속도, 회전 방향 및 온오프 기능 등의 매개 변수를 아날로그 또는 디지털 인터페이스를 통해 외부적으로 제어할 수 있습니다.

이 모델에서는, 싱글 채널 또는 멀티 채널 펌프 헤드를 선택할 수 있습니다. 
유량은 펌프 헤드에 따라 달라집니다.싱글 채널 헤드는 분당 0.38~813ml이고, 
멀티 채널 헤드는 분당 0.005~364 ml입니다. 공정에 따라 다음 매개 변수를 장치에서 설정할 수 있습니다.
속도, 튜빙 지름, 유량 디스플레이,계량 부피, 투여 간격 및 쉬는 시간. 펌프는 최적의 투여 결과를 위해 조정됩니다."""
                  },
                ]),
              ],
            ),
                        ...
                        child: SelectableText.rich(
                          TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text:
                                    '으로, 전 세계의 석유, 화학, 광업,제약, 식품, 향료, 인쇄 및 환경 산업 분야의 연구를 수행하는 고객들의 신뢰를 받고 있습니다.\n'
                                    'CINC 원심분리기는 조정 가능한 중(重)상 위어(weir)와 가변 속도 모터를 통해  특정 중력 차이에 따른 다양한 요구에 유연하게 대응할 수 있으며,자가 흡입 설계로 펌프 또는 중력 공급이 가능해'
                                    '유량 변화에도 안정적인 성능을 제공합니다.또한 모든 제품은 사내에서 설계, 제조 및 철저한 테스트를 거쳐 최고의 품질을 보장합니다.\nISO 9000 및 NAQ-1 기준을 준수하며, cGMP 및 FED 표준에 따라 원심분리기를 제조하고,CE 및'
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width : 8.w),
                                      SelectableText(
                                        '중량 차이를 처리할 수 있는 조절 가능한 중상위어와\n가변 속도 모터, 펌프식 및 중력식 모두 대응',
                                        style: TextStyle(
                                          color: Color(0xFF414141),
                                          fontSize:10.sp,
                                          fontFamily: 'Pretendard',
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width : 8.w),
                                      SelectableText(
                                        '하나의 움직이는 부품만 있는 간단한 직접 구동 방식으로\n안정성 강화',
                                        style: TextStyle(
                                          color: Color(0xFF414141),
                                          fontSize:10.sp,
                                          fontFamily: 'Pretendard',
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            ...
            return AlertDialog(
              ...
              content: Container(
                height: content.length >= 700 ? 600.h : 900.h,
                  ...
                  children: [
                    ...
                    Container(
                      child: SelectableText(
                        content,
                        style: TextStyle(
                          fontSize: content.length >= 700 ? 9.sp : 11.sp,
                          height: height * 0.00142,
                          // 줄 간격 추가
                          fontFamily: 'Pretendard',
